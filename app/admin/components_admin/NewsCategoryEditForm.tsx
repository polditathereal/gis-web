...
interface NewsCategoryEditFormProps {
...
const NewsCategoryEditForm: React.FC<NewsCategoryEditFormProps> = ({ categoryEdit, setCategoryEdit, handleEdit, handleDelete }) => (
...
export default NewsCategoryEditForm;
